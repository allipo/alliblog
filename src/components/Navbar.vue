<template>
  <div class="font-serif">
    <div
      class="invisible md:visible fixed top-0 left-0 w-full min-h-screen md:w-48 bg-white"
    >
      ...
      <div
        class="h-40 mt-16 mb-16 ml-8 pl-4 flex justify-between flex-col text-gray-800 text-lg border-l border-black"
      >
    ...
    <div
      class="mx-auto md:hidden fixed bottom-0 inset-x-0 mb-4 z-30 w-12 sm:w-20"
    >
      <g-image
        class="mx-auto flip drop dred"
        src="~/cute.png"
        width="100"
    ...
    <div
      v-if="this.showNav"
      class="navbor gap-x-2 sm:gap-x-6 flex text-xs sm:text-base fixed md:hidden inset-x-0 bottom-0 mx-2 sm:mx-6 mb-6 justify-around z-20"
    >
      <g-link class="link" to="/">Home</g-link>
      <g-link class="link" to="/blog">Blog</g-link>
